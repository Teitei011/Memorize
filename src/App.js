    ...
    if (saved) {
      ...
      const defaultTexts = [
        ...
        },
        {
          ...
          content: "The reading passage discusses [main topic] while the lecture [casts doubt on/contradicts/challenges] the claims presented. The professor addresses the ideas in the reading by providing [number] specific counterarguments.\nThe reading states that [reading point 1]. However, the lecturer contends that [lecture point 1]. To illustrate this, [specific example/evidence from lecture]. This directly undermines the reading's assertion about [briefly restate the idea being challenged].\nAdditionally, the reading claims [reading point 2]. The professor questions this by explaining that [lecture point 2]. Specifically, [specific detail/example from lecture]. This evidence suggests that [brief explanation of how this contradicts the reading].\nFinally, according to the reading, [reading point 3]. Yet the lecture refutes this by pointing out that [lecture point 3]. The professor demonstrates this through [specific example from lecture], which contradicts the reading's position on [briefly restate the challenged idea].",
